  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bio as @bio" do
        ...
        post :create, {:bio => { "image" => "invalid value" }}, valid_session
        assigns(:bio).should be_a_new(Bio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bio" do
        ...
        Bio.any_instance.should_receive(:update).with({ "image" => "MyString" })
        put :update, {:id => bio.to_param, :bio => { "image" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bio as @bio" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bio.any_instance.stub(:save).and_return(false)
        put :update, {:id => bio.to_param, :bio => { "image" => "invalid value" }}, valid_session
        assigns(:bio).should eq(bio)
      end
